...
| 函数名 | 参数 | 返回值 | 功能描述 |
| :--- | :--- | :--- | :--- |
| public String unicode\(String source\) | String source | String | 明文转unicode |
| public String decodeUnicode\(String unicode\) | String unicode | String | unicode转明文 |
| public String unicodeForMe\(String unicode\) | String unicode | Strihng | unicode转化为我的unicode |
| public String reUnicodeForMe\(String unicodeForMe\) | String unicodeForMe | String | 我的unicode转化为unicode |
| public String getPassword\(String password, int numberI, int numberII, int numberIII, int numberIV\) | String password, int numberI, int numberII, int numberIII, int numberIV | String | 小工具：一个格式转化“/u87t3”-&gt;"u87c123e3" |
| public String StringToNumber\(String string\) | String string | String | "123"-&gt;123 |
| ~~public String getStringText\(\)~~ | ~~null~~ | ~~String~~ | ~~获取text~~ |
| ~~public void setStringText\(String stringText\)~~ | ~~String stringText~~ | ~~null~~ | ~~设置text~~ |
| ~~public String getCode\(\)~~ | ~~null~~ | ~~String~~ | ~~获取code~~ |
| ~~public void setCode\(String code\)~~ | ~~String code~~ | ~~null~~ | ~~设置code~~ |
